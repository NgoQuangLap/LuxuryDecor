        ...
        <div class="hero__slider owl-carousel">
            <c:forEach var="banner" items="${banners }">
                <div class="hero__items set-bg"
                     data-setbg="${pageContext.request.contextPath}/file/upload/${banner.urlImage}">
                        <%--                <div class="hero__items set-bg" data-setbg="${pageContext.request.contextPath}/images/banner5.jpg">--%>
                        <%--						<div class="hero__items set-bg" data-setbg="${pageContext.request.contextPath}/images/banner5.jpg">--%>
                        ...
                        <div class="row">
                            <div class="col-xl-5 col-lg-7 col-md-8">
                                <div class="hero__text">
                                    ...
                                    <a href="${pageContext.request.contextPath}/${banner.url}" class="primary-btn">Khám
                                        phá ngay
                                    </a>
                                ...
                                <ul class="product__hover">
                                    <c:choose>
                                        <c:when test="${item.userLiked(USER) == true }">
                                            <li onclick="favorite.favorite(${item.id});"><a><img class="img_${item.id }"
                                                                                                 src="${pageContext.request.contextPath}/images/redheart.png"
                                                                                                 alt=""><span>Yêu thích</span></a>
                                            </li>
                                        </c:when>
                                        <c:otherwise>
                                            <li onclick="favorite.favorite(${item.id});"><a><img class="img_${item.id }"
                                    ...
                                    <li><a><img src="${pageContext.request.contextPath}/images/compare.png"
...
<section class="categories spad">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <div>
                    <h2><span>Sofa da luxury </span></h2>
                    <h4><span>Thiết kế sang trọng, hiện đại</span></h4>
            ...
            <div class="col-lg-4 offset-lg-1">
                <div class="categories__deal__countdown">
                    ...
                    <h2>Sofa da Luxury of VietNam</h2>
                    ...
                    <a href="${pageContext.request.contextPath}/shop-details/mvvk2-mvvm2-macbook-pro-16-inch-2019-i9-2-3-64gb-8tb-1609917082161"
...
<c:forEach items="${collections}" var="collection">
    ...
    <section class="product__service container">
        <div class="product__service__bar">
            ...
            <!-- notice -->
            <div class="product__service__more"><a
                    href="${pageContext.request.contextPath}/shop/search?collectionid=${collection.id}">Xem thêm</a>
            </div>
        </div>
        <div class="row hihi">
